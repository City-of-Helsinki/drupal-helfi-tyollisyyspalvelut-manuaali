...
/**
 * Defines the 'hel_tpm_editorial_paragraphs_accessibility' field widget.
 *
 * @FieldWidget(
 *   id = "hel_tpm_editorial_paragraphs_accessibility",
 *   label = @Translation("Paragraphs Accessibility"),
 *   field_types = {"entity_reference_revisions"},
 * )
 */
class ParagraphsAccessibilityWidget extends ParagraphsWidget {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $element_top['actions']['actions']['collapse_button']['#access'] = FALSE;
    $element_top['#attributes']['class'][] = 'paragraph-type-top';
