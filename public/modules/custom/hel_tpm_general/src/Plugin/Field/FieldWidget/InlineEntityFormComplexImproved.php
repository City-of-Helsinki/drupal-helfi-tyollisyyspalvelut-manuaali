...
class InlineEntityFormComplexImproved extends InlineEntityFormComplex {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    if (empty($open_form)) {
      if ($settings['allow_existing']) {
        ...
        if ($key !== FALSE) {
          $element['form']['#ief_element_submit'][$key] = [
            get_class($this), 'referenceFormSubmit',
          ];
        }
      }
   ...
   *
   * @return array
   *   Inline entity reference form.
   */
  private function referenceForm(array $reference_form, FormStateInterface &$form_state) {
   ...
   * {@inheritdoc}
   */
  public static function referenceFormSubmit(array $reference_form, FormStateInterface $form_state) {
  ...
  public function getCreateBundles() {
    $bundles = parent::getCreateBundles();
   ...
   *
   * @return void|null
   *   Returns nothing when there is no entities.
   */
  protected function disableEdit(array &$element, int $entity_count) {
