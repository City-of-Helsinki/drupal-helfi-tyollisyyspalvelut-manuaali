 ...
 */
class ServiceStateOutdatedSubscriber implements EventSubscriberInterface {
   ...
   *   Returns nothing.
   */
  public function serviceOutdated(ServiceModerationEvent $event) {
    ...
    $this->moderationTransition->setServiceOutdated($node, 'Outdated by service state subscriber');
  }
  ...
  public static function getSubscribedEvents() {
    return [
      'service_manual_workflow.published.to.outdated' => ['serviceOutdated'],
      'service_manual_workflow.draft.to.outdated' => ['serviceOutdated'],
    ];
  }
