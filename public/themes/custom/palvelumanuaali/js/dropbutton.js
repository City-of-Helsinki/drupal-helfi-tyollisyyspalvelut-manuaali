  ...
  $.extend(
    ...
    /** @lends Drupal.theme */ {
      ...
      dropbuttonToggle(options) {
        return `<${options.type} class="dropbutton-toggle"><button type="button"><span class="dropbutton-arrow"><span class="visually-hidden">${options.title}</span></span></button></div>`;
      },
    },
  );
